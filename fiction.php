...
<html lang="fr">
    ...
    <body>
		...
		<img src="Images/AustriaGoettweigAbbey.jpg" alt="Photo de la bibliothèque de l'abbaye de Gottweig en Autriche" title="Abbaye de Goettweig en Autriche" />
			...
			<h1>Livres - fiction</h1>
				<div class="intro">
				<p>Voici les livres du genre drame ma bibliothèque. Parcours la liste des titres ou choisis un autre genre du livre du menu.</p>
				</div>
